...
pygame.display.set_caption("Space Shooter by @bombonef")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        #spaceship image
        image = pygame.image.load("images/PNG/spaceship.png")
        ...
        damage_image = pygame.image.load("images/PNG/Damage/damage.png")
...
class Meteor(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(f"images/PNG/Meteors/{color}_{size}_{num}.png")
...
bg = pygame.image.load("images/Backgrounds/blue.png")
